...
/* Line icons drawn on a 24-unit grid in the current text colour, so each one
   takes its tone from wherever it sits rather than carrying its own. */
...
/**
 * The street along the bottom of the sign-in page's left panel.
 *
 * Drawn rather than photographed: there is no licensed photo in the repository,
 * and an illustration takes its colours from tokens, so it has a dark-mode
 * version for free. The houses shrink to the right to read as a street going
 * away, and the whole scene fades out at the top into the panel's sky.
 */
