...
import { followUpCount, isStale, lastTouch, leadAge, needsFollowUp, staleness, useLeads } from '@/domain/leads/leads'
  ...
  const rows: DataRow[] = leads.map((l) => {
    ...
    return {
      ...
      c: [
        ...
        { v: labelOf(LSTATUS, l.st)[0], chip: labelOf(LSTATUS, l.st)[1] },
        {
